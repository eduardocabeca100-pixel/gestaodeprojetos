...
echo "================================================="
echo " Corrigindo erro Vercel - Timeline de etapas"
echo "================================================="
...
TS="$(date +%Y%m%d-%H%M%S)"
BACKUP_DIR=".backup-vercel-timeline-$TS"
REPORT_DIR="artifacts/vercel-fix-$TS"
...
echo "Recriando server action sem exportar tipos extras..."
...
echo "Recriando timeline interna do projeto..."
...
echo "Recriando timeline do dashboard..."
...
echo "Ajustando chamadas das páginas..."
...
if [ "$BUILD_STATUS" -ne 0 ]; then
  echo ""
  echo "BUILD LOCAL AINDA FALHOU."
  echo "Veja as últimas linhas:"
  echo "--------------------------------------"
  tail -120 "$REPORT_DIR/build.log"
  echo "--------------------------------------"
  echo ""
  echo "Relatório completo salvo em:"
  echo "$REPORT_DIR/build.log"
  echo ""
  echo "Não faça git push ainda."
  exit 1
fi

echo ""
echo "BUILD PASSOU LOCALMENTE."
echo "Agora pode subir para o GitHub/Vercel."
