...
function buildDraft(
  ...
  return {
    ...
    modality: project.modality || "Ações de Qualificação e Formação",
    area: project.className || "Artes cênicas",
    workload: template?.workload ?? "33h",
    city: project.city,
    ...
    directorGeneral: "Marcel Eduardo Cabeça Domingues",
    executiveDirector: "Kaique",
    registry: nextNumber,
    book: "Livro 01",
    folio: "Folhas 01-02",
    notes: "",
